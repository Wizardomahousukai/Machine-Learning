...
// Predicted summary of Classes if the exercise has a measurement of about 0.34 its predicted to be a class A excercise. if it has a measurement of about 0.204, its predicted to be a class B exercise. If it has a measurement of about 0.14, its predicted to be a class C exercise. If it has a measurement of about 0.18, its predicted to be a class D exercise.If it has a measurement of about 0.127, its predicted to be a class E exercise.
